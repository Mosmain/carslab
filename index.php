            ...
            <table class="table">
                ...
                foreach ($key as $cars) {
                    ...
                    <tr>
                        ...
                        <td><?= $cars['hp'] ?></td>
                        <td>
                            <a href="?edit=<?= $cars['id'] ?>" class="btn btn-success btn-sm" data-toggle="modal"
                               data-target="#editModal<?= $cars['id'] ?>"><i class="fa fa-edit"></i></a>
                            <a href="?delete=<?= $cars['id'] ?>" class="btn btn-danger btn-sm" data-toggle="modal"
                               data-target="#deleteModal<?= $cars['id'] ?>"><i class="fa fa-trash"></i></a>
